      ...
      <div className="min-h-screen pt-14 pl-[200px] bg-gray-50">
        <div className="max-w-6xl mx-auto px-6 py-12">
          <div className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <h1 className="text-2xl font-bold text-gray-800 mb-2">Sign in to view Watch Later</h1>
      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            ...
            <p className="text-gray-500">{watchLater.length} video{watchLater.length !== 1 ? "s" : ""}</p>
          </div>
        </div>
        ...
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <h2 className="text-xl font-semibold text-gray-800 mb-2">No videos saved</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
            {watchLater.map((item, index) => (
              ...
              >
                ...
                <h3 className="font-medium text-gray-900 line-clamp-2 text-sm mb-1 group-hover:text-blue-600 transition-colors">
                  {item.video?.title}
                </h3>
