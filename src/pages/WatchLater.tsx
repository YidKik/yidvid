      ...
      <div className="min-h-screen pt-14 pl-[200px] bg-white flex flex-col">
        <div className="flex-1 max-w-6xl mx-auto px-6 py-12">
          <div className="flex flex-col items-center justify-center py-20 text-center">
            <div className="w-24 h-24 rounded-full bg-yellow-50 flex items-center justify-center mb-6 shadow-sm">
              <Clock className="w-12 h-12 text-yellow-500" />
            </div>
            <h1 className="text-2xl font-bold text-gray-900 mb-2 font-friendly">Sign in to view Watch Later</h1>
    ...
    <div className="min-h-screen pt-14 pl-[200px] bg-white flex flex-col">
      <div className="flex-1 max-w-6xl mx-auto px-6 py-8">
        ...
        <div className="flex items-center gap-4 mb-8 pb-6 border-b border-gray-100">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900 font-friendly">Watch Later</h1>
            <p className="text-gray-500 mt-1">{watchLater.length} video{watchLater.length !== 1 ? "s" : ""} saved</p>
          </div>
        </div>
        ...
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <h2 className="text-xl font-semibold text-gray-900 mb-2 font-friendly">No videos saved</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {watchLater.map((item, index) => (
              ...
              >
                ...
                <h3 className="font-semibold text-gray-900 line-clamp-2 text-sm mb-1.5 group-hover:text-yellow-600 transition-colors">
                  {item.video?.title}
                </h3>
