        ...
        <div className="flex-1 max-w-6xl mx-auto px-6 py-12">
          <div className="flex flex-col items-center justify-center py-20 text-center">
            <div className="w-24 h-24 rounded-full bg-[#F5F5F5] flex items-center justify-center mb-6 shadow-sm">
              <Heart className="w-12 h-12 text-[#FF0000]" />
            </div>
            <h1 className="text-2xl font-bold text-[#1A1A1A] mb-2 font-friendly">Sign in to view your favorites</h1>
    ...
    <div className="min-h-screen pt-14 pl-[200px] bg-white flex flex-col">
      <div className="flex-1 max-w-6xl mx-auto px-6 py-8">
        <div className="flex items-center gap-4 mb-8 pb-6 border-b border-[#E5E5E5]">
          <div className="w-16 h-16 rounded-2xl bg-[#FF0000] flex items-center justify-center shadow-lg">
            <Heart className="w-8 h-8 text-white fill-white" />
          </div>
          <div>
            <h1 className="text-2xl font-bold text-[#1A1A1A] font-friendly">Favorites</h1>
            <p className="text-[#666666] mt-1">{favorites.length} video{favorites.length !== 1 ? "s" : ""} saved</p>
          </div>
        </div>
        ...
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <h2 className="text-xl font-semibold text-[#1A1A1A] mb-2 font-friendly">No favorites yet</h2>
