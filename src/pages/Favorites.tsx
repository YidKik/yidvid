        ...
        <div className="flex-1 max-w-6xl mx-auto px-4 lg:px-6 py-12">
          <div className="flex flex-col items-center justify-center py-20 text-center">
            <div className="w-20 h-20 lg:w-24 lg:h-24 rounded-full bg-[#F5F5F5] flex items-center justify-center mb-6 shadow-sm">
              <Heart className="w-10 h-10 lg:w-12 lg:h-12 text-[#FF0000]" />
            </div>
            <h1 className="text-xl lg:text-2xl font-bold text-[#1A1A1A] mb-2 font-friendly">Sign in to view your favorites</h1>
    ...
    <div className="min-h-screen pt-14 pl-0 lg:pl-[200px] bg-white flex flex-col pb-20 lg:pb-0">
      <div className="flex-1 max-w-6xl mx-auto px-4 lg:px-6 py-6 lg:py-8">
        <div className="flex items-center gap-3 lg:gap-4 mb-6 lg:mb-8 pb-4 lg:pb-6 border-b border-[#E5E5E5]">
          <div className="w-12 h-12 lg:w-16 lg:h-16 rounded-2xl bg-[#FF0000] flex items-center justify-center shadow-lg">
            <Heart className="w-6 h-6 lg:w-8 lg:h-8 text-white fill-white" />
          </div>
          <div>
            <h1 className="text-xl lg:text-2xl font-bold text-[#1A1A1A] font-friendly">Favorites</h1>
            <p className="text-sm text-[#666666] mt-1">{favorites.length} video{favorites.length !== 1 ? "s" : ""} saved</p>
          </div>
        </div>
        ...
        {isLoading ? (
          <div className="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 lg:gap-6">
            {[...Array(8)].map((_, i) => (
              <div key={i} className="animate-pulse">
                ...
                <div className="h-4 bg-[#F5F5F5] rounded-full w-3/4 mb-2" />
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <h2 className="text-lg lg:text-xl font-semibold text-[#1A1A1A] mb-2 font-friendly">No favorites yet</h2>
            ...
            <Button
              ...
              className="mt-6 rounded-full bg-[#FFCC00] hover:brightness-90 text-[#1A1A1A] font-semibold px-6 shadow-md hover:shadow-lg transition-all"
            >
              Browse Videos
            </Button>
          </div>
