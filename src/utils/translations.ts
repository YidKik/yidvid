...
export const translations: Translations = {
  ...
  welcomeToJewTube: 'Welcome to JewTube!',
  jewTubeDescription: 'JewTube is your dedicated platform for discovering and engaging with Jewish content from various YouTube channels. Our mission is to create a centralized hub where you can easily find, watch, and interact with meaningful Jewish content.',
