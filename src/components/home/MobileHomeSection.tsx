  ...
  return (
    <div className="min-h-screen w-full bg-[#003c43] px-6 py-12 overflow-y-auto">
      <div className="flex flex-col items-center text-center space-y-4 mb-12">
        ...
        <p className="text-[#77b0aa] text-lg">
          Watch, share, and connect with the finest Jewish content from around the world.
        </p>
        <Link 
          to="/explore"
          className="px-6 py-2 border-2 border-[#77b0aa] text-[#e3fef7] rounded-full text-lg hover:bg-[#135d66] transition-colors duration-300"
        >
          Explore
        </Link>
      </div>
