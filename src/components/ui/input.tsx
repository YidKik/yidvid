    ...
    return (
      <input
        ...
        className={cn(
          ...
          // Don't apply default styles to search inputs - let them use their own CSS
          !className?.includes('search-input') && "border border-input focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2",
          className
        )}
        ref={ref}
        {...props}
