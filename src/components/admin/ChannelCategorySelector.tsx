...
export const ChannelCategorySelector = () => {
  ...
  const { data: channels = [], isLoading } = useQuery({
    queryKey: ["admin-channels-category", searchQuery],
    queryFn: async () => {
      let query = supabase
  ...
  const handleBulkCategoryUpdate = async () => {
    ...
    try {
      ...
      setSelectedChannels([]);
      setBulkCategory("");
      queryClient.invalidateQueries({ queryKey: ["admin-channels-category"] });
    } catch (error) {
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center justify-between mt-2">
                      <Badge className={`text-xs ${getCategoryBadgeColor(channel.default_category)}`}>
