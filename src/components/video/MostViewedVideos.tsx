        ...
        <div className="relative px-1 md:px-4">
          ...
          <div className="relative overflow-hidden min-h-[140px] md:min-h-[200px]">
            ...
            pointerEvents: isTransitioning ? 'none' : 'auto'
              ...
              {currentVideos.map(video => <div key={video.id} className="group relative rounded-lg overflow-hidden transition-all duration-700 hover:shadow-xl">
            ...
            pointerEvents: isTransitioning ? 'auto' : 'none'
                ...
                {nextVideos.map(video => <div key={video.id} className="group relative rounded-lg overflow-hidden transition-all duration-700 hover:shadow-xl">
                    <div className="relative aspect-video">
                      <VideoCard {...video} hideInfo={isMobile} />
                    </div>
                  </div>)}
