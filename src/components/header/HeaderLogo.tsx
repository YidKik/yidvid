  ...
  return (
    <div className={`flex items-center ${isMobile ? '' : 'absolute left-0 top-1/2 -translate-y-1/2 ml-0 pl-0'}`}>
      <Link to="/" className="flex items-center">
        <img 
          src={isMobile ? "/lovable-uploads/c9065db3-96c9-44e7-b74a-ac03c1c18e2c.png" : "/lovable-uploads/e425cacb-4c3a-4d81-b4e0-77fcbf10f61c.png"}
          alt="YidVid Logo"
          className={`object-contain drop-shadow-md ${isMobile ? 'h-24 w-auto' : 'h-32 w-auto'}`}
          onError={(e) => {
