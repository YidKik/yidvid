    ...
    <form onSubmit={onSearch} className="w-full max-w-lg flex items-center relative group">
      <div className="search-animated-border w-full relative">
        <Input
          ...
          onFocus={handleFocus}
          onBlur={handleBlur}
          className={`w-full bg-transparent z-10 relative border-none text-[#555555] placeholder:text-[#555555] focus-visible:ring-0 focus-visible:ring-offset-0 ${isMobile ? 'h-8 text-sm' : 'h-10 text-sm'} pr-10 md:pr-14`}
        />
