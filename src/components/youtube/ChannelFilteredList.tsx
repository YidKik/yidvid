  ...
  return (
    <div className={`relative ${isLocked ? 'pointer-events-none' : ''}`}>
      ...
      <div className="my-3 md:my-4">
        <div className="flex items-center gap-2 p-1.5 md:p-2 bg-white rounded-lg border border-gray-200">
          <Search className="h-3.5 w-3.5 md:h-4 md:w-4 text-gray-500" />
          <ChannelSearch value={searchQuery} onChange={setSearchQuery} />
        </div>
      </div>

      <div className="max-h-[280px] md:max-h-[350px] overflow-y-auto scrollbar-hide space-y-1.5 md:space-y-2">
