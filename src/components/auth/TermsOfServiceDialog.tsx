    ...
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-[800px] max-h-[80vh] p-0 gap-0 overflow-hidden">
        <DialogHeader className="p-6 pb-2 border-b">
          <DialogTitle className="text-xl font-bold text-center text-white">Terms of Service</DialogTitle>
        ...
        <ScrollArea className="p-6 max-h-[60vh] text-white">
          <div className="space-y-4">
            ...
            <h3 className="text-lg font-semibold text-white">5. Content and Intellectual Property</h3>
            <p className="text-white/90">
            ...
            <h3 className="text-lg font-semibold text-white">8. Modifications to the Service</h3>
            <p className="text-white/90">
