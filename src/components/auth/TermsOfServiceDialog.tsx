        ...
        >
          ...
          >
            <div className="space-y-4 text-sm leading-relaxed" style={{ color: '#333' }}>
              ...
              <h3 className="text-base font-bold" style={{ color: '#222' }}>3. Third-Party Services and Terms</h3>
              ...
              <h3 className="text-base font-bold" style={{ color: '#222' }}>4. Eligibility</h3>
              ...
              <h3 className="text-base font-bold" style={{ color: '#222' }}>5. User Accounts</h3>
              ...
              <h3 className="text-base font-bold" style={{ color: '#222' }}>6. User Conduct</h3>
              ...
              <h3 className="text-base font-bold" style={{ color: '#222' }}>7. Content and Intellectual Property</h3>
              ...
              <h3 className="text-base font-bold" style={{ color: '#222' }}>8. DMCA and Copyright Complaints</h3>
              ...
              <h3 className="text-base font-bold" style={{ color: '#222' }}>9. Privacy</h3>
              ...
              <h3 className="text-base font-bold" style={{ color: '#222' }}>10. Disclaimers and Limitation of Liability</h3>
              ...
              <h3 className="text-base font-bold" style={{ color: '#222' }}>11. Indemnification</h3>
              ...
              <h3 className="text-base font-bold" style={{ color: '#222' }}>12. Modifications to the Service and Terms</h3>
              ...
              <h3 className="text-base font-bold" style={{ color: '#222' }}>13. Termination</h3>
              ...
              <h3 className="text-base font-bold" style={{ color: '#222' }}>14. Governing Law and Dispute Resolution</h3>
              ...
              <h3 className="text-base font-bold" style={{ color: '#222' }}>15. Severability</h3>
              ...
              <h3 className="text-base font-bold" style={{ color: '#222' }}>16. Entire Agreement</h3>
              ...
              <h3 className="text-base font-bold" style={{ color: '#222' }}>17. Contact Us</h3>
