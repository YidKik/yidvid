        ...
        >
          ...
          >
            <div className="space-y-4 text-sm leading-relaxed" style={{ color: '#333' }}>
              ...
              <h3 className="text-base font-bold" style={{ color: '#222' }}>4. Cookies and Tracking Technologies</h3>
              ...
              <h3 className="text-base font-bold" style={{ color: '#222' }}>5. How We Use Your Information</h3>
              ...
              <h3 className="text-base font-bold" style={{ color: '#222' }}>6. Third-Party Services and Data Sharing</h3>
              ...
              <h3 className="text-base font-bold" style={{ color: '#222' }}>7. Data Retention</h3>
              ...
              <h3 className="text-base font-bold" style={{ color: '#222' }}>8. Data Security</h3>
              ...
              <h3 className="text-base font-bold" style={{ color: '#222' }}>9. Your Rights and Choices</h3>
              ...
              <h3 className="text-base font-bold" style={{ color: '#222' }}>10. Children's Privacy</h3>
              ...
              <h3 className="text-base font-bold" style={{ color: '#222' }}>11. International Data Transfers</h3>
              ...
              <h3 className="text-base font-bold" style={{ color: '#222' }}>12. California Privacy Rights (CCPA)</h3>
              ...
              <h3 className="text-base font-bold" style={{ color: '#222' }}>13. European Privacy Rights (GDPR)</h3>
              ...
              <h3 className="text-base font-bold" style={{ color: '#222' }}>14. Email Communications</h3>
              ...
              <h3 className="text-base font-bold" style={{ color: '#222' }}>15. Changes to Our Privacy Policy</h3>
              ...
              <h3 className="text-base font-bold" style={{ color: '#222' }}>16. Contact Us</h3>
