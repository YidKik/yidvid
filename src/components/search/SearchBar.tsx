        ...
        <PopoverTrigger asChild>
          <div className="relative">
            <Input
              ...
              className="w-full pl-12 py-6 rounded-xl bg-[#F2F2F2] border-transparent focus:border-gray-300 hover:border-gray-300 transition-colors duration-200 focus:ring-0 focus:ring-offset-0 ring-0 outline-none"
            />
