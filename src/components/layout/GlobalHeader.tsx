      ...
      >
        <div className="w-full px-3 md:px-6">
          <div className="flex items-center justify-between h-14 gap-4">
            {/* Left Side - Menu button on homepage, spacer otherwise */}
            ...
            {!isHomePage ? (
              ...
              /* Homepage - Logo in center instead of search */
            ...
            {/* Right Side - Notifications (not on homepage) + Sign In / Profile */}
            <div className="flex items-center gap-2 shrink-0">
              {/* Notification Bell - hidden on homepage */}
