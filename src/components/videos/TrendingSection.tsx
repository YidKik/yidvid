      ...
      <AnimatePresence mode="wait">
        {showAllVideos ? (
          ...
          >
            ...
            {/* Pagination Arrows */}
            <div className={`flex justify-center items-center ${isMobile ? 'gap-2 mt-4' : isTablet ? 'gap-3 mt-6' : 'gap-6 mt-10'}`}>
              <button
              ...
              >
                Next
                <ChevronRight className={isMobile ? 'w-3 h-3' : isTablet ? 'w-3.5 h-3.5' : 'w-5 h-5'} />
              </button>
            </div>
          </motion.div>
        ) : (
