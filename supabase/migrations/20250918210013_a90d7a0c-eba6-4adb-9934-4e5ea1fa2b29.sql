-- Add content analysis fields to youtube_videos table
...
ALTER TABLE youtube_videos 
ALTER COLUMN content_analysis_status TYPE content_analysis_status USING content_analysis_status::content_analysis_status;
